...
let pk2 = fs.readFileSync(`${__dirname}/wallet/publicKeyus2.pem`)
let pk3 = fs.readFileSync(`${__dirname}/wallet/publicKeyus3.pem`)
let pk4 = fs.readFileSync(`${__dirname}/wallet/publicKeyus4.pem`)
let pk5 = fs.readFileSync(`${__dirname}/wallet/publicKeyus2.pem`)

let arr = [pk2, pk3, pk4, pk5]
...
connectToDB().then(() => {
    for (let t of txn) {
        ...
        let pms = [p2.save(), p3.save(), p4.save(), p5.save()]
